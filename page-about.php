...
<section class="ab-sec--alt">
    <div class="ab-sec-inner">
        ...
        <table class="ab-facts">
            ...
            <tr><td>Ассортимент</td><td>17 цветов · готовые наборы на 2–6 персон · индивидуальный пошив</td></tr>
    ...
    <div class="ab-sec-inner">
        ...
        <div class="ab-reasons">
            ...
            <div class="ab-reason">
                ...
                <div class="ab-reason-text">Конкуренты продают скатерти и салфетки врозь. Покупателю приходится самому подбирать, что с чем сочетается. Мы делаем иначе: <a href="<?php echo home_url('/product/gotovyj-nabor/'); ?>">готовые комплекты</a> на 2, 4 и 6 персон. Скатерть, дорожка, салфетки, куверты — всё в одном цвете.</div>
            </div>
            <div class="ab-reason">
